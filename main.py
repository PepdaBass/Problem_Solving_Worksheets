...
add_fibo_number = int(input('Enter a number to begin a fibonacci sequence: '))
fibo_number = []
fibo_number.append(add_fibo_number)
fibonacci_fun = False
fibonacci_string = ''
...
while make_fibo_string is False:
   if len(fibo_number) == 1:
       make_fibo_string = True
       fibonacci_string += str(fibo_number.pop(0))
   elif len(fibo_number) > 1:
       fibonacci_string += (str(fibo_number.pop(0)) + ', ')
